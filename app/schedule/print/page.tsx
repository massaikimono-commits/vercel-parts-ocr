...
function dueParts(entry: PreviewEntry) {
  ...
  if (entry.plannedDeliveryDate) return { date: shortDate(entry.plannedDeliveryDate), time: "" };
  if (entry.expectedCompletionDate) return { date: shortDate(entry.expectedCompletionDate), time: "" };
  return { date: "", time: "" };
}
