...
export default function SchedulePage() {
  ...
  function renderCard(item: typeof enriched[number]) {
    ...
    return (
      <article key={entry.id} data-work-id={work?.id || undefined} className={`scheduleItem type-${entry.entry_type} ${!isDelivery && entry.completed ? "done" : ""} ${work?.is_urgent ? "urgentItem" : ""} ${work && focusWorkId === work.id ? "focusedWork" : ""}`}>
        <div className="itemTop">
        ...
        <div className="meta secondaryMeta">
          {work?.worker_name && <span>担当 {work.worker_name}</span>}
