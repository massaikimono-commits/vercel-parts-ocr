      ...
      <style jsx global>{`
        *{box-sizing:border-box}body{margin:0;background:#f3f6fb;color:#172033;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}button{font:inherit}
        ...
        @media(max-width:650px){
          ...
          .tableCard{border:0;background:transparent;overflow:visible;display:grid;gap:10px}.tableHead{display:none}.loadRow{min-width:0;grid-template-columns:1fr 1fr;gap:8px;padding:14px;background:#fff;border:1px solid #d9e0ea;border-radius:16px}.loadRow:first-of-type{border-top:1px solid #d9e0ea}.loadRow>b{grid-column:1/-1;font-size:17px;padding-bottom:4px;border-bottom:1px solid #edf0f4}.loadRow span,.loadRow strong{display:grid;grid-template-columns:1fr auto;align-items:center;gap:8px;text-align:right;border-radius:10px;padding:8px 10px;min-height:42px}.loadRow span::before,.loadRow strong::before{font-size:11px;color:#718096;font-weight:800;text-align:left}.loadRow span:nth-child(2)::before{content:"未完了"}.loadRow span:nth-child(3)::before{content:"未実施"}.loadRow span:nth-child(4)::before{content:"作業中"}.loadRow span:nth-child(5)::before{content:"急ぎ"}.loadRow span:nth-child(6)::before{content:"完了待ち"}.loadRow span:nth-child(7)::before{content:"入庫中"}.loadRow span:nth-child(8)::before{content:"最長滞留"}.loadRow strong:nth-child(9)::before{content:"合計"}.loadRow.unassigned{border-color:#f2c99e}.empty{background:#fff;border:1px solid #d9e0ea;border-radius:16px}
        }
      `}</style>
    </main>
  );
