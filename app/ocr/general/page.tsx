...
export default function GeneralOCRPage() {
  ...
  async function runOCR(file: File) {
    ...
    try {
      ...
      worker = await tesseract.createWorker("jpn+eng", 1, { workerPath: "/tesseract/worker.min.js", corePath: "/tesseract/core", langPath: "/tesseract/lang",  logger: (m: any) => { if (m.status === "recognizing text") setProgress(Math.max(5, Math.round((m.progress || 0) * 95))); } });
