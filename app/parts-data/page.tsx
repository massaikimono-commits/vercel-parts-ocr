  ...
  return (
    <main className="page">
      ...
      <section className="card partsLead">
        <h1>部品データ管理</h1>
        <p className="partsIntro">OCRで保存した部品を車両ごとに整理します。作業車両を選んでからOCRした場合は、今回追加した部品をまとめて紐付けできます。</p>
