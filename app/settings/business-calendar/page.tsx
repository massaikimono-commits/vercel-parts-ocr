      ...
      <style jsx global>{`
        *{box-sizing:border-box}body{margin:0;background:#f3f6fb;color:#172033;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}
        ...
        @media(max-width:620px){
          .calendarPage{padding:7px 7px 34px}.top{margin-bottom:5px}.top button{padding:7px 9px;min-height:40px}.calendarHead{padding:9px;margin-bottom:7px;border-radius:14px}.titleRow{display:grid;gap:6px}.titleRow h1{font-size:19px}.titleRow span{font-size:10px}.yearNav{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:4px}.yearNav button{min-width:0;padding:7px 3px;min-height:40px;font-size:11px}.summary{margin-top:6px;gap:4px}.summary b{font-size:10px;padding:4px 6px}.notice{margin-top:5px;padding:6px 8px;font-size:12px}.monthsGrid{grid-template-columns:1fr;gap:7px}.monthCard{padding:8px;border-radius:14px}.monthHead{margin-bottom:4px}.monthHead h2{font-size:16px}.weekdays,.daysGrid{gap:2px}.dayCell,.blankDay{height:45px}.dayCell{padding:3px 1px}.dayCell span{font-size:13px}.dayCell small{font-size:7.5px}.dayEditor{padding:8px;margin-top:6px;gap:6px}.rangeTool{margin-top:8px;border-radius:14px}.rangeTool summary{padding:11px 12px;font-size:13px}.rangeBody{padding:10px 12px}.rangeGrid{grid-template-columns:1fr}.helpCard{margin-top:8px;padding:10px 12px}.helpCard p{font-size:12px}
        }
      `}</style>
    </main>
  );
