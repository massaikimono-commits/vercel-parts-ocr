  ...
  return (
    <main className="page">
      ...
      <section className="card hero">
        ...
        <p className="heroVehicleText">{[vehicle?.maker, vehicle?.model || vehicle?.model_code].filter(Boolean).join(" / ") || "車両情報を確認中"}</p>
      ...
      <section className={`card decision ${needsReview ? "review" : "ready"}`}>
        ...
        <p className="decisionReason">{manualTemplate ? "担当者が記録簿を選択しました。" : automaticDecision?.reason || "車両情報が不足しています。"}</p>
