...
export default function VehicleWorkflowFast(){
  ...
  const [message,setMessage]=useState("車検証を読み取るか、作業車両を選んでください。"),[busy,setBusy]=useState(true),[docBusy,setDocBusy]=useState(false),[saving,setSaving]=useState(false),[progress,setProgress]=useState(0),[preview,setPreview]=useState(""),[debug,setDebug]=useState("");
