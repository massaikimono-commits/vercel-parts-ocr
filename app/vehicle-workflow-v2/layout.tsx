...
import CertificateCriticalCellsV2 from "../certificate-critical-cells-v2";
...
// 5. v2 rejects impossible kei height values such as a leaked axle weight, then reads the two date cells and the true dimension row together in one final pass.
