...
import CertificateCriticalCellsV3 from "../certificate-critical-cells-v3";
...
// 5. v3 safely rejects impossible kei height values, then recalibrates issue date, record date and the real dimension row together in one final OCR pass.
