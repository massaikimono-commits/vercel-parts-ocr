...
import CertificateK3QrRecoveryV4 from "../certificate-k3-qr-recovery-v4";
...
// 2. If K3/32 alone is missing, v4 checks the right-shifted QR centers only.
