...
// 5. If record/registration dates are still blank, v1 reads only those two small cells.
// 6. For kei vehicles, impossible height values are rejected and v4 reads only the right-side width/height cell in one composite pass.
// 7. Legacy heavy OCR stacks remain unmounted.
