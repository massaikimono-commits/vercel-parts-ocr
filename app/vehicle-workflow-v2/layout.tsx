...
import CertificateCriticalCellsV6 from "../certificate-critical-cells-v6";
...
// 5. v6 replaces the exact-cell date reader with a wider upper-band sweep. It extracts numeric date candidates and validates them against already trusted first-registration and expiry values; kei height keeps the proven dimension-row recovery.
// 6. v5 and older date/height fallback stacks remain unmounted to avoid repeated OCR and state races.
