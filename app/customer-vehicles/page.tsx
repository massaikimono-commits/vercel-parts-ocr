  ...
  return (
    <main className="page">
      ...
      <section className="card">
        ...
        <button className="bulkVehicleEntry" onClick={() => location.assign("/vehicle-workflow/bulk")}>📄 複数PDFをまとめて車両登録</button>
        ...
        <>
          <section className="card detail">
            ...
            <div className="actions">
              ...
              <button onClick={() => location.assign("/vehicle-workflow-v2")}>車両情報を編集</button>
            </div>
          </section>
